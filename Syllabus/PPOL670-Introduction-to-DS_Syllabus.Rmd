...
- **_Required_**: PPOL501 - Statistical Methods for Policy Analysis (or an equivalent course)
- **_Preferred_**: PPOL502 - Regression Methods for Policy Analysis (or an equivalent course)
