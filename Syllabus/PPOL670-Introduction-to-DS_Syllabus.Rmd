...
- **Office Hours**: by appointment online (https://calendly.com/nhl8/one-on-one)
...
Classes will be held on **Wednesdays** from **_6:30pm to 9:00pm_** in **White-Gravenor 211**: 
...
**Canvas**: A Canvas site (**http://canvas.georgetown.edu**) will be used periodically throughout the course and should be checked on a regular basis. All readings and assignments will be posted on Canvas; they will not be distributed in class or by e-mail. Support for Canvas is available at (202) 687-4949
...
**Problem Sets** (45%): Students will be assigned six problem sets. While you are encouraged to discuss the problem sets with your peers and/or consult online resources, **the finished product must be your own work**. Problem sets are due on the date and time posted on Canvas and must be submitted on Canvas. Late assignments will be penalized a letter grade for every day they are overdue.
...
|-----------|---------------|--------------|
    No. 1   |  September 18 | September 25
    No. 2   |  September 25 | October 2   
    No. 3   |  October 9    | October 16 
    No. 4   |  October 16   | October 23
    No. 5   |  October 30   | November 6
    No. 6   |  November 20   | November 27
...
| ------------------------- |  ------------- | ----------- | ----------------|
|    Project Proposal       |   November 13  |  2 pages    |       5%        |
|    Presentation           |   December 4   |  10 minutes |       10%       |
|    Project Report         |   December 14  |  12 pages   |       30%       |

Students will use Git/Github for version control and will use the reproducibility practices covered the first week of class. Details regarding each aspect of the project will be posted on CANVAS leading up to the first due date. Each student will be required to create a public Github repository in which all aspects of the project will be housed. 
