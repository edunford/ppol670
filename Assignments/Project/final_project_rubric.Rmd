...
- Report was posted on Canvas? (1 point)
  - `.pdf` rendered using RMarkdown. (1 point)
  - `.Rmd` file containing all the code used to generate the analytics in the report. (1 point)
