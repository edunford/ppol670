...
- **Student used `R` Markdown for a professional looking report:**
  ...
  + Report includes a title and author byline. (__/1 point)
  + Report includes a word count. (__/1 point)
  + Report is 12 pages in length (double-spaced; 12 pt font) if rendered as `.pdf`/`.docx`. (__/1 point)
