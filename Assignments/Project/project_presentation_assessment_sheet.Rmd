...
- Student rendered their materials as slides in R Markdown (or Rpres)? (_score_:___)
...
- Student used the entire allotted time (i.e. the presentation was precisely 7 minutes). (_score_:___)
