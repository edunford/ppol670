...
When faced with a large set of _correlated_ variables, **principal components** allow us to summarize dataset with a large number of variables with a smaller number of representative variables that collectively explain most of the variability in the original set. 
...
- We want to explore this data visually, but if $p$ is large, that would require many plots!
  ...
  - e.g. $p = 10$ means $45 plots$! (i.e. $\frac{p(p-1)}{2}$ )
