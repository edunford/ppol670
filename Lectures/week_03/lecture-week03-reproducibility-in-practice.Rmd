...
**Contender 2**: Binding each iteraction
```{r}
N = 5000
tic()
dat_container <- c()
...
.center[**Bold** or _italize_ text. Or **_both_**! ~~Even cross things out~~]
...
Chunk output can be customised with options, arguments supplied to chunk header. Knitr provides almost [60 options](http://yihui.name/knitr/options/) that you can use to customize your code chunks.
