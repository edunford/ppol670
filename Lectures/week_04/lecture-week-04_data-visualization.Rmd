...
knitr::opts_chunk$set(echo = T,message=F,error=F,warning = F,cache = TRUE)
require(lubridate)
require(tidyverse)
require(ggthemes)
require(gghighlight)
...
.center[
<img src="Figures/drake-bad-plot.png", width = 550>
]
...
tibble(y,x) %>% 
  ...
  labs(color="",pch="",x="X",y="Y",
       title="Simulated Treatment Discontinuity",
...
.center[<img src="Figures/violent-events-2016_by-adm-unit_by-dataset.png", width=900>]
...
.pull-right[
.center[<img src="Figures/amounts-1.png", width=600>]
.center[<img src="Figures/proportions-1.png", width=600>]
.center[<img src="Figures/single-distributions-1.png", width=600>]
.center[<img src="Figures/basic-scatter-1.png", width=600>]
]
...
.pull-right[
```{r,fig.align="center",fig.height=6,highlight=T}
ggplot(data=diamonds,
       aes(x=price,y=carat)) +
  geom_point() 
```
...
.pull-right[
```{r, ref.label="dem_gdp1", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp2", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp3", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp4", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp5", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp6", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp7", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp8", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp9", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp10", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp11", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp12", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="dem_gdp13", echo=FALSE}
```
]
...
```{r,fig.align="center",echo=F,fig.width=10,fig.height=8}
pol %>%
...
.pull-right[
```{r, ref.label="sa_dem1", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_dem2", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_dem3", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_dem4", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_dem5", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_dem6", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_dem7", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_dem8", echo=FALSE}
```
]

---

```{r,echo=F,fig.align="center",fig.height=8}
pol2 %>%
  ggplot(aes(x=year,y=polity,
             group=country)) +
  geom_line(color="grey20",size=.75) +
...
.pull-right[
```{r, ref.label="sa_wave1", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave2", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave3", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave4", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave5", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave6", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave7", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave8", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave9", echo=FALSE}
```
]
...
.pull-right[
```{r, ref.label="sa_wave10", echo=FALSE}
```
]
