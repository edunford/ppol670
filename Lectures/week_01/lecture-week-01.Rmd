...
read_csv(here('Syllabus/fall-2019-timeline.csv')) %>% 
  ...
  slice(1:(n()-3)) %>% 
  kable(., "html") %>% 
  kable_styling(font_size = 24,position = 'center')
```
...
- a "big data" course (we won't delve into database structures such as SQL and Hadoop).
...
# Reproducibility<br>as a<br>Practical Reality
...
- Clearly **_state all dependencies** (i.e. packages/modules) at the top of every script
