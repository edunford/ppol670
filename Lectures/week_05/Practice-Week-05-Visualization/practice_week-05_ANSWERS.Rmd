...
plt3 <-
  ...
  geom_histogram(color="white",fill="wheat",bins=30) +
  theme_minimal()
plt3
```
...
For this question, I'm going to simulate some data.

```{r}
set.seed(123)
fake_data <-tibble(V1 = rnorm(10000),V2 = 2*V1 + rnorm(10000,sd=5))
head(fake_data)
```
...
```{r,fig.align="center",fig.width=10,fig.height=10}
plt4 +geom_density2d(color="red",lwd=1)
```
