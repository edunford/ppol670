...
require(rvest)
urls <- c("https://www.bbc.com/news/world-us-canada-47764237",
...
```{r,eval=F,fig.align="center",fig.width=12,fig.height=10}
text_data_cnts2 %>%
  group_by(story_id) %>% 
  top_n(5, tf_idf) %>% 
  ungroup() %>%
...
```{r,echo=F,fig.align="center",fig.width=12,fig.height=8,dpi=200}
text_data_cnts2 %>%
  group_by(story_id) %>% 
  top_n(5, tf_idf) %>% 
  ungroup() %>%
...
```{r,fig.align="center",fig.width=12,fig.height=7,dpi=200,highlight=T}
...
```{r,fig.align="center",fig.width=10,fig.height=4.75,dpi=200,highlight=T}
text_data %>% ungroup %>% 
...
```{r,fig.align="center",fig.width=10,fig.height=4.75,cache=T,dpi=200}
obama_txt %>% 
...
```{r,eval=F,fig.align="center",fig.width=10,fig.height=10,cache=F,highlight=T,dpi=200}
obama_txt %>% 
...
```{r,echo=F,fig.align="center",fig.width=10,fig.height=7,cache=T,highlight=T,dpi=200}
obama_txt %>% 
  group_by(word,address) %>% 
  summarize(n = n(),score=max(value)) %>% 
  filter(n>1) %>% 
...
```{r,fig.align="center",fig.width=9.5,fig.height=4,cache=T,dpi=200}
ap_top_terms %>%
