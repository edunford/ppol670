...
We can also use the metrics package to calculate performance metrics.
```{r}
# If the package isn't installed on your machine
# install.packages("Metrics")

pred <- predict(mod_rf,newdata = test_data2)

# Mean squared error
Metrics::mse(actual=test_data2$cnt,predicted = pred)
```
